...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import validatePolicy from './validate-policy'
 ...
 */
export default function ({ enableWarn = true, policy = <span class="branch-0 cbranch-no" title="branch not covered" >{} } = defaultParams) {</span>
